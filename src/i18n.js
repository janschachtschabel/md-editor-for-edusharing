...
const MESSAGES = {
  de: {
    ...
    'toolbar.toc': 'Inhaltsverzeichnis am Dokumentanfang einfügen bzw. aktualisieren',
    'toc.heading': 'Inhaltsverzeichnis',
    'controller.duplicate': '{label} ist bereits getaggt',
    'users.jumpTitle': 'klicken springt zur Cursor-Position',
    'image.uploadError': 'Bild-Upload fehlgeschlagen: {detail}',
    'comments.buttonTitle': 'Kommentare ein-/ausblenden',
    'comments.title': 'Kommentare',
    'comments.close': 'Kommentare schließen',
    'comments.placeholder': 'Kommentar schreiben … (markierter Text wird als Bezug angehängt)',
    'comments.send': 'Senden',
    'comments.replyBtn': 'Antworten',
    'comments.replyingTo': 'Antwort an {name}',
    'comments.deleteTitle': 'Kommentar löschen',
    'comments.deleteConfirm': 'Diesen Kommentar löschen?',
    'comments.quoteJumpTitle': 'Zur Textstelle springen',
    'comments.empty': 'Noch keine Kommentare.',
    'comments.loadError': 'Kommentare konnten nicht geladen werden.',
    'comments.sendError': 'Kommentar konnte nicht gespeichert werden.',
    'comments.markTitle': '{count} Kommentar(e) zu dieser Stelle — klicken öffnet das Panel',
    'toolbar.imageUpload': 'Bild hochladen',
    'toolbar.imgSmall': 'Bildbreite: klein (240 px)',
    'toolbar.imgMedium': 'Bildbreite: mittel (480 px)',
    'toolbar.imgLarge': 'Bildbreite: groß (720 px)',
    'toolbar.imgFull': 'Bildbreite: Original (volle Breite, responsiv)',
    'media.upload': '⬆ Hochladen',
    'media.uploadTitle': 'Bild hochladen — wird am Knoten gespeichert und in den Text eingefügt',
    'toolbar.imageMedia': 'Bilder einfügen & verwalten',
    'media.insertUrl': '🔗 Bild-URL',
    'media.insertUrlTitle': 'Externes Bild per URL einfügen (keine Ablage im Repository)',
    'media.title': 'Bilder',
    'media.close': 'Medienverwaltung schließen',
    'media.empty': 'Keine hochgeladenen Bilder an diesem Knoten.',
    'media.loadError': 'Bilder konnten nicht geladen werden.',
    'media.insert': 'Einfügen',
    'media.insertTitle': 'Bild an der Cursor-Position in den Text einfügen',
    'media.deleteTitle': 'Bild endgültig aus dem Repository löschen',
    'media.deleteConfirm': '„{name}" endgültig aus dem Repository löschen?',
    'media.deleteConfirmReferenced': '„{name}" wird noch im Text verwendet! Beim Löschen bleibt dort ein toter Bild-Link zurück. Trotzdem löschen?',
    'media.referenced': 'im Text',
    'media.referencedTitle': 'Wird im aktuellen Text verwendet — die automatische Bereinigung löscht nur unbenutzte Bilder',
    'toolbar.exportMd': 'Aktuellen Stand als Markdown-Datei herunterladen',
    'toolbar.print': 'Drucken (bereinigte Lesefassung)',
    'find.buttonTitle': 'Suchen und Ersetzen',
    'find.findPlaceholder': 'Suchen …',
    'find.replacePlaceholder': 'Ersetzen durch …',
    'find.next': 'Weiter',
    'find.replace': 'Ersetzen',
    'find.replaceAll': 'Alle ersetzen',
    'find.close': 'Suche schließen',
    'find.count': '{count} Treffer',
    'editor.wordCount': '{words} Wörter · ~{min} min',
    'editor.wordCountTitle': 'Wortzahl und Lesezeit (ca. 200 Wörter/min)',
    'glossary.button': '📇 Glossar',
    'glossary.buttonTitle': 'Entitäten-Glossar am Dokumentende einfügen bzw. aktualisieren',
    'glossary.heading': 'Glossar',
    'doc.viewerLabel': 'Viewer-Modus',
    'doc.viewerTitle': 'Nur-Lese-Ansicht ohne Werkzeugleiste (steuert das viewer-Attribut der Komponente)',
    ...
    'ai.errorNoPending': 'Keine offenen KI-Vorschläge',
    'ai.reviewReady': 'KI: {count} Vorschläge — bitte prüfen',
    'ai.suggested': '{count} KI-Vorschläge warten auf Prüfung',
    'ai.discarded': 'KI-Vorschläge verworfen',
    'ai.review.title': 'KI-Vorschläge prüfen:',
    'ai.review.rolePrefix': 'Rolle',
    'ai.review.apply': 'Ausgewählte übernehmen',
    'ai.review.discard': 'Verwerfen',
  ...
  en: {
    ...
    'toolbar.toc': 'Insert or update the table of contents at the top of the document',
    'toc.heading': 'Table of contents',
    'controller.duplicate': '{label} is already tagged',
    'users.jumpTitle': 'click jumps to their cursor',
    'image.uploadError': 'Image upload failed: {detail}',
    'comments.buttonTitle': 'Show/hide comments',
    'comments.title': 'Comments',
    'comments.close': 'Close comments',
    'comments.placeholder': 'Write a comment … (selected text is attached as the anchor)',
    'comments.send': 'Send',
    ...
    'comments.quoteJumpTitle': 'Jump to the passage',
    'comments.empty': 'No comments yet.',
    'comments.loadError': 'Comments could not be loaded.',
    'comments.sendError': 'The comment could not be saved.',
    'comments.markTitle': '{count} comment(s) on this passage — click to open the panel',
    'toolbar.imageUpload': 'Upload image',
    'toolbar.imgSmall': 'Image width: small (240 px)',
    'toolbar.imgMedium': 'Image width: medium (480 px)',
    'toolbar.imgLarge': 'Image width: large (720 px)',
    'toolbar.imgFull': 'Image width: original (full width, responsive)',
    'media.upload': '⬆ Upload',
    'media.uploadTitle': 'Upload an image — stored on the node and inserted into the text',
    'toolbar.imageMedia': 'Insert & manage images',
    'media.insertUrl': '🔗 Image URL',
    'media.insertUrlTitle': 'Insert an external image by URL (not stored in the repository)',
    'media.title': 'Images',
    'media.close': 'Close media management',
    'media.empty': 'No uploaded images on this node.',
    'media.loadError': 'Images could not be loaded.',
    'media.insert': 'Insert',
    'media.insertTitle': 'Insert the image into the text at the cursor',
    'media.deleteTitle': 'Permanently delete the image from the repository',
    'media.deleteConfirm': 'Permanently delete "{name}" from the repository?',
    'media.deleteConfirmReferenced': '"{name}" is still used in the text! Deleting leaves a dead image link there. Delete anyway?',
    'media.referenced': 'in text',
    'media.referencedTitle': 'Used in the current text — the automatic cleanup only removes unused images',
    'toolbar.exportMd': 'Download the current state as a markdown file',
    'toolbar.print': 'Print (clean reading view)',
    'find.buttonTitle': 'Find and replace',
    ...
    'find.count': '{count} matches',
    'editor.wordCount': '{words} words · ~{min} min',
    'editor.wordCountTitle': 'Word count and reading time (approx. 200 words/min)',
    'glossary.button': '📇 Glossary',
    'glossary.buttonTitle': 'Insert or update the entity glossary at the end of the document',
    'glossary.heading': 'Glossary',
    'doc.viewerLabel': 'Viewer mode',
    'doc.viewerTitle': 'Read-only view without the toolbar (drives the component\'s viewer attribute)',
    ...
    'ai.errorNoPending': 'No pending AI suggestions',
    'ai.reviewReady': 'AI: {count} suggestions — please review',
    'ai.suggested': '{count} AI suggestions awaiting review',
    'ai.discarded': 'AI suggestions discarded',
    'ai.review.title': 'Review AI suggestions:',
    'ai.review.rolePrefix': 'Role',
    'ai.review.apply': 'Apply selected',
    'ai.review.discard': 'Discard',
